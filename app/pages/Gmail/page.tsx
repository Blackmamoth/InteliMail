...
const Gmail = () => {
  ...
  <MaxWidthWrapper>
<div className="text-white font-semibold  pb-7 -mt-5"><div className="flex gap-x-2 items-center"><img className="rounded-full w-9 h-9" src="/gmail.png"></img> <span className="text-3xl font-medium text-black dark:text-white">{pathname.slice(1,pathname.length)}</span> </div></div>
